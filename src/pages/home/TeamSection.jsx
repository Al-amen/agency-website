        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              />
              <div className="p-5">
                <h3 className="text-xl front-semibold text-gray-800 mb-2">
                  {member.name}
                </h3>
                <p className="text-sm text-gfray-500 mb-4">{member.role}</p>

                {/* social icon */}
                <div className="flex space-x-4 mb-5 items-center">
                  <Link to={member.linkedIn}>
                    <FaLinkedinIn className="text-blue hover:text-blue-800" />
                  </Link>
                  <Link to={member.twitter}>
                    <FaTwitter className="text-blue hover:text-blue-800" />
                  </Link>
                  <Link to={member.instagram}>
                    <FaInstagram className="text-blue hover:text-blue-800" />
                  </Link>
                  <Link to={member.facebook}>
                    <FaFacebookF className="text-blue hover:text-blue-800" />
                  </Link>
                </div>
                {/* contact button */}
